...
! function (t) {
    ...
    i.resize = E(u, k), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function (t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && T()
    ...
    window.tram = function (t) {
        ...
        var I = e.frame = function () {
            ...
            L = l(function (e) {
                ...
                e.init = function (e) {
                    ...
                    z.backface && B.hideBackface && Z(this.el, z.backface.css, "hidden")
        ...
        z.transform && (Y.transform = [q], K = {
            ...
            skewX: [_],
            skewY: [_]
        }), z.transform && z.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [w], K.perspective = [y]);
        var Q = /ms/,
            J = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    n(4), n(7), n(8), n(9), n(10), n(11), t.exports = n(14)
}, function (t, e, n) {
    "use strict";
    var i = n(0);
    ...
    i.define("dropdown", t.exports = function (t, e) {
        ...
        function A() {
            n = f && i.env("design"), (u = T.find(p)).each(S)
        }
        ...
        function S(e, r) {
            ...
            l || (l = t.data(r, p, {
                ...
                e.mouseUpOutside && T.off(k, e.mouseUpOutside);
                return c(function (n) {
                    if (e.open) {
                        var r = t(n.target);
            ...
            n && l.el.on(O, function (t) {
                return function (e, n) {
                    n = n || {}, C(t), !0 === n.open && z(t), !1 === n.open && M(t, {
                        immediate: !0
                    })
                }
            ...
            }(l)), l.el.on(E, g), l.el.on(b, function (t) {
                return function (e) {
                    if (!n && !d && t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
                        case o.HOME:
                            if (!t.open) return;
                            return t.selectedIdx = 0, j(t), e.preventDefault();
                        case o.END:
                            if (!t.open) return;
                            return t.selectedIdx = t.links.length - 1, j(t), e.preventDefault();
                        case o.ESCAPE:
                            return M(t), t.toggle.focus(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                            return t.selectedIdx = Math.min(t.links.length - 1, t.selectedIdx + 1), j(t), e.preventDefault();
                        case o.ARROW_LEFT:
                        case o.ARROW_UP:
                            return t.selectedIdx = Math.max(-1, t.selectedIdx - 1), j(t), e.preventDefault()
                    }
                }
            ...
            }(l)), l.toggle.on(k, g), l.toggle.on(b, function (t) {
                var e = R(t, a);
                return function (i) {
                    if (!n && !d) {
        ...
        function z(e) {
            if (!e.open) {
                ...
                var r = i.env("editor");
                n || T.on(k, e.mouseUpOutside), e.hovering && !r && e.el.on(_, e.mouseLeave), e.hovering && r && T.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function M(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var r = t.config;
                if (m.outro(0, t.el[0]), T.off(k, t.mouseUpOutside), T.off(x, t.mouseMoveOutside), t.el.off(_, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
